...
def main(args):
    ...
    # enable model EMA (appendix B of the paper)
    ...
    for epoch in range(args.start_epoch, max_epochs):
        ...
        for _ in range(cfg["train_cfg"]["num_eval_samples"]):
            ...
            # yet eventually help to stablize samples during late stage of training
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Train Denoising Diffusion Probabilistic Models for image generation"
    )
